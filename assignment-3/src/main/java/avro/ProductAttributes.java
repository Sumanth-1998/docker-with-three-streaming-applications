...
public class ProductAttributes extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8181404556508700839L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductAttributes\",\"namespace\":\"avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"productId\",\"type\":\"string\"},{\"name\":\"key\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"string\"}]}");
   ...
   */
  public static BinaryMessageEncoder<ProductAttributes> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a ProductAttributes instance decoded from the given buffer
   ...
   */
  public ProductAttributes(java.lang.CharSequence id, java.lang.CharSequence productId, java.lang.CharSequence key, java.lang.CharSequence value) {
    this.id = id;
   ...
   */
  public static avro.ProductAttributes.Builder newBuilder() {
    return new avro.ProductAttributes.Builder();
  }
   ...
   * @return A new ProductAttributes RecordBuilder
   */
  public static avro.ProductAttributes.Builder newBuilder(avro.ProductAttributes.Builder other) {
    if (other == null) {
      return new avro.ProductAttributes.Builder();
    } else {
      return new avro.ProductAttributes.Builder(other);
    }
  }
   ...
   * @return A new ProductAttributes RecordBuilder
   */
  public static avro.ProductAttributes.Builder newBuilder(avro.ProductAttributes other) {
    if (other == null) {
      return new avro.ProductAttributes.Builder();
    } else {
      return new avro.ProductAttributes.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductAttributes>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.ProductAttributes.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.ProductAttributes other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder setKey(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder clearKey() {
      key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder setValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.ProductAttributes.Builder clearValue() {
      value = null;
